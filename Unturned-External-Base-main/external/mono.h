...
constexpr auto GET_ROOT_DOMAIN_OFFSET = 0x751020; // NOTE: can easily update by finding the address that mono_get_root_domain returns by disassembling the mono dll in ida (i dont see you needing to do this anyitme soon)
